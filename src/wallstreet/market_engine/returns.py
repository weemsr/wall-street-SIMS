...
SECTOR_PARAMS: dict[Regime, dict[Sector, tuple[float, float]]] = {
    Regime.BULL: {
        ...
        Sector.CONSUMER:      (0.006, 0.025),
        Sector.CONSUMER_DISC: (0.013, 0.055),
        Sector.INDUSTRIALS:   (0.010, 0.040),
        Sector.HEALTHCARE:    (0.008, 0.035),
    },
    Regime.BEAR: {
        Sector.TECH:          (-0.015, 0.065),
        Sector.ENERGY:        (-0.010, 0.070),
        Sector.FINANCIALS:    (-0.020, 0.060),
        Sector.CONSUMER:      (-0.003, 0.030),
        Sector.CONSUMER_DISC: (-0.018, 0.065),
        Sector.INDUSTRIALS:   (-0.012, 0.055),
        Sector.HEALTHCARE:    (-0.003, 0.040),
    },
    Regime.RECESSION: {
        Sector.TECH:          (-0.025, 0.075),
        Sector.ENERGY:        (-0.020, 0.080),
        Sector.FINANCIALS:    (-0.030, 0.070),
        Sector.CONSUMER:      (-0.004, 0.035),
        Sector.CONSUMER_DISC: (-0.028, 0.075),
        Sector.INDUSTRIALS:   (-0.022, 0.060),
        Sector.HEALTHCARE:    (-0.005, 0.045),
    },
    Regime.RECOVERY: {
        Sector.TECH:          (0.012, 0.055),
        Sector.ENERGY:        (0.015, 0.060),
        Sector.FINANCIALS:    (0.016, 0.050),
        Sector.CONSUMER:      (0.005, 0.028),
        Sector.CONSUMER_DISC: (0.014, 0.055),
        Sector.INDUSTRIALS:   (0.012, 0.045),
        Sector.HEALTHCARE:    (0.007, 0.035),
    },
}
...
RATE_MODIFIERS: dict[RateDirection, dict[Sector, tuple[float, float]]] = {
    RateDirection.RISING: {
        ...
        Sector.CONSUMER_DISC: (-0.002, 1.05),
        Sector.INDUSTRIALS:   (-0.001, 1.05),
        Sector.HEALTHCARE:    (0.000, 1.00),
    },
    RateDirection.STABLE: {
        ...
        Sector.CONSUMER_DISC: (0.000, 1.00),
    ...
    RateDirection.FALLING: {
        ...
        Sector.CONSUMER_DISC: (0.003, 0.95),
        Sector.INDUSTRIALS:   (0.001, 0.98),
        Sector.HEALTHCARE:    (0.001, 0.98),
    },
}
